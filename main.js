...
global.channelLink = "https://whatsapp.com/channel/0029Vb6awTZ4Crfpdok0kC2L";
global.ytch = "ANICADE Tech";
        ...
        if (message.message?.buttonsResponseMessage) {
            ...
            if (buttonId === 'channel') {
                await sock.sendMessage(chatId, {
                    text: '📢 *Join our Channel:*\nhttps://whatsapp.com/channel/0029Vb6awTZ4Crfpdok0kC2L'
                }, { quoted: message });
                return;
                ...
                await sock.sendMessage(chatId, {
                    text: `🔗 *Support*\n\nhttps://chat.whatsapp.com/H0TicPRKigLL3ZfDUm7Bjj`
                }, { quoted: message });
                return;
            }
        }
